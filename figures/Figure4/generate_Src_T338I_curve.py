...
inputs = {
    ...
    'file_set'      :  {'Src': glob("../../data/single-wavelength/Src_T338I/2019-07-15/*.xml"),                        
...
plt.title('Src T338I',fontsize=20)
plt.yticks([])
...
plt.savefig('Src_T338I_binding_curve.png', dpi=500)
plt.savefig('Src_T338I_binding_curve.pdf')
