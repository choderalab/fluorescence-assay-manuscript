...
inputs = {
    ...
    'file_set'      :  {'Src': glob("../../data/single-wavelength/Src/2019-07-10/*.xml"),                        
                        ...
                        'Abl': glob("../../data/single-wavelength/Abl_T334I/2019-07-15/*.xml")},
...
plt.title('Abl T334I',fontsize=20)
plt.yticks([])
...
plt.savefig('Abl_T334I_binding_curve.png', dpi=500)
plt.savefig('Abl_T334I_binding_curve.pdf')
